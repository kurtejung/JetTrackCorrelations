...
// Mon Jul 11 14:24:40 2016 by ROOT version 5.34/20
...
public :
   ...
   Float_t         trkPt[19984];   //[nTrk]
   Float_t         trkPtError[19984];   //[nTrk]
   UChar_t         trkNHit[19984];   //[nTrk]
   UChar_t         trkNlayer[19984];   //[nTrk]
   Float_t         trkEta[19984];   //[nTrk]
   Float_t         trkPhi[19984];   //[nTrk]
   Int_t           trkCharge[19984];   //[nTrk]
   UChar_t         trkNVtx[19984];   //[nTrk]
   Int_t           nTrkTimesnVtx;
   Bool_t          trkAssocVtx[19984];   //[nTrkTimesnVtx]
   Float_t         trkDxyOverDxyError[19984];   //[nTrkTimesnVtx]
   Float_t         trkDzOverDzError[19984];   //[nTrkTimesnVtx]
   Bool_t          highPurity[19984];   //[nTrk]
   Bool_t          tight[19984];   //[nTrk]
   Bool_t          loose[19984];   //[nTrk]
   Float_t         trkChi2[19984];   //[nTrk]
   UChar_t         trkNdof[19984];   //[nTrk]
   Float_t         trkDxy1[19984];   //[nTrk]
   Float_t         trkDxyError1[19984];   //[nTrk]
   Float_t         trkDz1[19984];   //[nTrk]
   Float_t         trkDzError1[19984];   //[nTrk]
   Bool_t          trkFake[19984];   //[nTrk]
   UChar_t         trkAlgo[19984];   //[nTrk]
   UChar_t         trkOriginalAlgo[19984];   //[nTrk]
   Float_t         trkMVA[19984];   //[nTrk]
   Bool_t          trkMVATight[19984];   //[nTrk]
   Int_t           pfType[19984];   //[nTrk]
   Float_t         pfCandPt[19984];   //[nTrk]
   Float_t         pfEcal[19984];   //[nTrk]
   Float_t         pfHcal[19984];   //[nTrk]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("HiForestAOD_1128.root:/anaTrack");
